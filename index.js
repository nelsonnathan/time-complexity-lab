...
// Starting Code:
function squareEveryDigit(number) { //I think the time complexity is O(n)
  let strNum = ''
  let newNum = []
  ...
  for (each in strNum) {
    newNum.push(Math.pow(strNum[each], 2))
  }

  console.log(newNum.join(''))
}

squareEveryDigit(10) // When running 946, you should see a result of 811636
